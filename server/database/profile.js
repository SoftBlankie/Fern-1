  ...
  getOne: id => {
    return knex('profile')
      .join('user', 'user.id', 'profile.user_id')
        .select('profile.id', 'user.name as name', 'profile.age', 'profile.location', 'profile.learning', 'profile.native', 'profile.about', 'profile.followers', 'profile.followings', 'user.date as date', 'user.is_active as is_active')
